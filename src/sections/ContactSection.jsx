...
const socialLinks = [
    ...
    //{ href: "mailto:nnquang15.work@gmail.com", icon: "/portfolio/icon/ico_email.png", alt: "Email" },
    { href: "x.com/solstrixstudio", icon: "/portfolio/icon/ico_x.png", alt: "X" },
    ...
    return (
        <>
            <section className="relative h-screen overflow-hidden bg-[#2b2b45]">
                ...
                {/* Centered content below the separator */}
                <div className="flex flex-col items-center justify-center h-[calc(100%-64px)] z-10">
                    ...
                    font-vt323 px-6 py-2 rounded transition"
                        ...
                        {/* Social buttons below the email button */}
